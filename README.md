---------
 This repository was forked from the Atlassian repository and updated to support Node20
---------
...
- [`Find issue key`]([https://github.com/marketplace/actions/jira-find-issue-key](https://github.com/NTTSH-Engineering/gajira-find-issue-key)) - Search for an issue key in commit message, branch name, etc. This issue key is then saved and used by the next actions in the same workflow
